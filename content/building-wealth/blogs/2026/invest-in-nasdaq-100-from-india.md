---
title: "How to Invest in NASDAQ 100 from India (Mutual Funds, ETFs, and IBKR Guide)"
date: "2026-03-14"
draft: false
type: "blogs"
wealth_tags:
...
📺 [Watch on YouTube](https://youtu.be/O555X0CSIzs) (First video I ever posted, excuse me for the low volume) &nbsp;

{{< youtube O555X0CSIzs >}}

📽️ Alternatively you can look at the [Slide](/building-wealth/slides/invest-in-nasdaq-100-from-india/) as well.
...
| Broker | Type | Notes |
|-|-|-|
| [Interactive Brokers (IBKR)](https://www.interactivebrokers.co.in/en/home.php) | Direct | Best pricing; no intermediary markup |
| [ICICI Direct Global](https://www.icicidirect.com/global-investment-services) | Custodian broker (IBKR) | Additional brokerage layer on top of IBKR costs |
| [Paasa](https://paasa.com/) | Custodian broker (IBKR) | India-friendly UX; additional fee layer |
...
|-|-|-:|-:|-|-|
| CNDX | [iShares Nasdaq 100 UCITS ETF (Acc)](https://www.justetf.com/en/etf-profile.html?isin=IE00B53SZB19) | 0.30% | $21,439m | LSE (CNDX), SIX (CSNDX) | IE00B53SZB19 |
| EQQQ | [Invesco EQQQ Nasdaq-100 UCITS ETF Acc](https://www.justetf.com/en/etf-profile.html?isin=IE00BFZXGZ54) | 0.30% | $3,511m | SIX (EQAC) | IE00BFZXGZ54 |
| **ANAU** | [AXA IM NASDAQ 100 UCITS ETF USD Acc](https://www.justetf.com/en/etf-profile.html?isin=IE000QDFFK00) | 0.14% | $1,804m | SIX (ANAU) | IE000QDFFK00 |
| **XNAS** | [Xtrackers Nasdaq 100 UCITS ETF 1C](https://www.justetf.com/en/etf-profile.html?isin=IE00BMFKG444) | 0.20% | $1,708m | LSE (XNAS) | IE00BMFKG444 |
| *QQQA* | [UBS Nasdaq-100 UCITS ETF USD Acc](https://www.justetf.com/en/etf-profile.html?isin=IE000SB4G4I4) | 0.13% | $118m | SIX (QQQA) | IE000SB4G4I4 |

- All are full replication, accumulating, Irish-domiciled ETFs. See live data: [JustETF — NASDAQ 100 UCITS ETFs](https://www.justetf.com/en/search.html?assetClass=class-equity&search=ETFS&index=Nasdaq%2B100%25C2%25AE&quoteCurrency=USD&distributionPolicy=distributionPolicy-accumulating&dc=IE&replicationType=replicationType-full&resetPage=true)
...
1. Login to your bank's remittance portal (e.g. HDFC RemitNow, ICICI Money2World)
2. Convert ₹ (INR) to $ (USD) and send to your IBKR account
3. Funds are typically credited in T / T+1 days

To reduce the FX markup on this transfer, consider using [FX Retail](/building-wealth/blogs/funding-interactive-brokers-from-india-using-fx-retail/) — it can save ₹1,000–₹1,600 per $1,000 transferred.
...
1. Login to IBKR
2. Search for **XNAS** on LSE (or **ANAU** on SIX) in USD
3. Check the previous day's NAV vs current market price
...
1. Negotiate with the bank for discounted rate before remitting.
2. See [Funding IBKR from India Using FX Retail](/building-wealth/blogs/funding-interactive-brokers-from-india-using-fx-retail/) for how to reduce this markup significantly.  

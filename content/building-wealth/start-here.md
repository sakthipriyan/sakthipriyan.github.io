...
What compounding actually does over a working life, and what it costs to notice
late.
...
This is the core sequence. If you're new to investing, start here.
...
Used to reduce cash drag in the bank account and rewards indirectly as extra earnings.
...
What should you own, how do you maintain it, and the tools to do so without
watching it daily.
...
/building-wealth/blogs/perpetual-rebalancing-a-practical-framework-for-long-term-wealth/
/building-wealth/blogs/perpetual-rebalancing-engineering-a-mathematically-superior-sip-allocator/
{{< /subjects >}}

## Investing beyond India

The largest subject here, and the one with the most moving parts. **Start with the
book (*The Global Indian Investor*)**; the posts below are the parts that changed
after I wrote it.
...
What I actually hold, published monthly — allocation, drift, what I bought and
...
/building-wealth/tools/realvalue-fx-engine/
{{< /subjects >}}

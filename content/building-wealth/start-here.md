...
A series covering one piece of a portfolio at a time. If you read nothing else,
read these in order.
...
book; the posts below are the parts that changed after I wrote it.
...
Buying is the easy part. This is the rule set that keeps a portfolio on course
without watching it daily, and the tools that apply it.

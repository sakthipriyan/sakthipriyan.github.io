...
layout: "slides"
type: "slides"
summary: "What a ₹1 Crore home loan at 8% truly costs — the gap between nominal fear and real burden across 10, 15, and 20 year tenures."
js_tools:
 - gsap
wealth_tags:
 - Debt
...
<p style="font-size: 1.4em; color: #ef4444;"><strong>Inflation. 6% per year.</strong></p>
<p style="font-size: 1.2em; margin-top: 10px;">₹83,644 in 2026 &nbsp;≠&nbsp; ₹83,644 in 2036 &nbsp;≠&nbsp; ₹83,644 in 2046.</p>
<p style="font-size: 1.1em; color: #6b7280; margin-top: 10px;">Nominal EMI stays fixed. Real burden shrinks every year.</p>
</div>
...
<div class="fragment fade-in-then-out">
<p style="font-size: 1.1em; color: #10b981;">📉 Monthly EMI — Real (₹83,644 -> ₹26,206)</p>
<img src="emi_real.png" style="width: 100%; border-radius: 8px; margin-top: 8px;" alt="Real EMI over 15 years"/>
</div>

<div class="fragment fade-in-then-out">
<p style="font-size: 1.1em; color: #6b7280;">🏦 Outstanding Loan — Nominal (slow decline)</p>
<img src="outstanding_nominal.png" style="width: 100%; border-radius: 8px; margin-top: 8px;" alt="Remaining loan nominal"/>
</div>

<div class="fragment">
<p style="font-size: 1.1em; color: #10b981;">🏦 Outstanding Loan — Real (relatively drops fast)</p>
<img src="outstanding_real.png" style="width: 100%; border-radius: 8px; margin-top: 8px;" alt="Remaining loan real"/>
</div>
...
<p class="fragment fade-in-then-out" style="font-size: 1.1em;">The "scary" ₹1.01 Cr interest on 20 years?</p>

<p class="fragment fade-in-then-out" style="font-size: 1.2em; color: #10b981;"><strong>In real terms — only ~19% of the loan.</strong></p>

<p class="fragment" style="font-size: 1.1em; color: #f59e0b;">Real total gap between 10 and 20 years: just <strong>₹8.2L</strong>.</p>
...
<div>
<p style="margin-top: 15px;"> Explore Scenarios:
...
<div style="font-size: 1.4em; margin: 50px 0;">

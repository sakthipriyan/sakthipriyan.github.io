---
title: "How to Transfer Money Efficiently?"
...
Steps involved in setting up or using **FX Retail** is explained in: **[Chapter 4: FX Retail - A Deep Dive](/building-wealth/books/the-global-indian-investor/04-fx-retail-a-deep-dive/)**
...
Detailed walkthrough is documented [here](/building-wealth/blogs/fx-retail-via-bharat-connect-private-bank-speed-at-public-bank-rates-a-live-transaction-walkthrough/) for my setup.
...
| Transaction Cost <br/> via **RealValue FX Engine** | [3.07%](https://sakthipriyan.com/building-wealth/tools/realvalue-fx-engine/#v1uid20260509r96b94.4255a100000f1000y0g12m3) | [1.59%](https://sakthipriyan.com/building-wealth/tools/realvalue-fx-engine/#v1uid20260509r94.6255b94.4255a100000f1000y0g12m3) | [2.02%](https://sakthipriyan.com/building-wealth/tools/realvalue-fx-engine/#v1uid20260509r96b94.4255a500000f1000y0g12m3) | [0.56%](https://sakthipriyan.com/building-wealth/tools/realvalue-fx-engine/#v1uid20260509r94.6255b94.4255a500000f1000y0g12m3) |
...
Projected using [RealValue SIP Engine](/building-wealth/tools/realvalue-sip-engine/#v1otd20yf202605c0lm0.015kg16h10i6t15p20y) (Read INR as USD while looking at the projection). You can play around with various parameters to project your savings.
...
1. Get approval from the bank backend team via branch forex team
2. Create deal in FX Retail system and forward to branch forex team
3. Wait for processing to happen by EoD
...
> For regular remittance flows, the [RealValue FX Engine](/building-wealth/tools/realvalue-fx-engine/) can be used to determine the exact USD amount that can be sent based on the INR amount allocated for the transfer. Also, it can be used for computing the transaction cost.
